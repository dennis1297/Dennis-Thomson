      ...
      <div class="row">
        <div class="col-md-12">
          <div class="page-title"><h1>PRIVACY POLICY</h1></div>
            ...
            <p>This privacy policy sets out how "vivekaessencemart.com" uses and protects any information that you give vivekaessencemart.com when you use this website.</p>
            <p>"vivekaessencemart.com" is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.</p>
            <p>"vivekaessencemart.com" may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.</p>
